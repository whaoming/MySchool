...
import com.wxxiaomi.myschool.bean.lib.format.LibLoginCodeFormat;
...
//	private EditText et_password;
	...
	private LibLoginCodeFormat info;
...
//		new AsyncTask<String, Void, LibLoginCodeFormat>() {
//			@Override
//			protected LibReceiverData<String> doInBackground(String... params) {
//				LibLoginCodeFormat r = null;
...
//
//			@Override
//			protected void onPostExecute(LibLoginCodeFormat result) {
...
//		final String password = et_password.getText().toString().trim();
		new AsyncTask<String, Void, LibMainFormat>() {
			@Override
			protected LibMainFormat doInBackground(String... params) {
//				LibraryEngineImpl engine = new LibraryEngineImpl();
//				LibMainFormat loginFromServer = engine.LoginFromServer(username,password,input,info.cookie);
//				return loginFromServer;
				return null;
			}

			@Override
			protected void onPostExecute(LibMainFormat result) {
//				if(result.success == 1){
