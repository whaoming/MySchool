...
//		this.context = ct;
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		holder.tv_time.setText("上课时间："+column.classTime);
		holder.tv_location.setText("上课地点："+column.location);
		if (isExpanded) {
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		holder.tv_number.setText("选课课号："+column.number);
		holder.tv_code.setText("课程代码："+column.code);
		holder.tv_teaName.setText("教师姓名："+column.teaName);
		holder.tv_creait.setText("学分："+column.creait);
		holder.tv_weekTime.setText("周学时："+column.weekTime);
		return convertView;
	}
