...
public class OfficeScoreAdapter extends BaseExpandableListAdapter {
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		holder.tv_subject.setText(column.classname);
		holder.tv_score.setText(column.score+"");
		return convertView;
	}
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		holder.tv_begins.setText("开课学院："+column.begins);
		holder.tv_term.setText("学期："+column.term);
		holder.tv_classcode.setText("课程代码："+column.classcode);
		holder.tv_classnature.setText("课程性质："+column.classnature);
		holder.tv_credit.setText("学分："+column.credit);
		holder.tv_point.setText("绩点："+column.point);
		holder.tv_schoolyear.setText("学年："+column.schoolyear);
		return convertView;
	}
